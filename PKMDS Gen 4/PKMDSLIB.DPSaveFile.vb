...
Partial Class PokemonLib
    ''' <summary>
    ''' A structure for containing Pokémon Diamond or Pearl save data.
    ''' </summary>
    ''' <remarks></remarks>
    <Serializable()> _
    <StructLayout(LayoutKind.Sequential, Size:=&H80000)> _
    Public Class DPSaveFile '0x80000 bytes

        'TODO: Fix HoF block / padding / whatever is causing save file structure to be 4 bytes too long.

#Region "Members"
        Private General1 As mDPGeneralBlock 'Starts at 0x00000, length is 0xC100
        Private Storage1 As mDPStorageBlock 'Starts at 0x0C100, length is 0x121E0
        <MarshalAs(UnmanagedType.ByValArray, sizeconst:=&H1D20)> _
        Public Padding1() As Byte
        Private HallOfFame1 As mDPHallOfFameBlock 'Starts at 0x20000, length is 0x2AC0
        <MarshalAs(UnmanagedType.ByValArray, sizeconst:=&H1D540)> _
        Public Padding2() As Byte
        Private General2 As mDPGeneralBlock 'Starts at 0x40000, length is 0xC100
        Private Storage2 As mDPStorageBlock 'Starts at 0x4C100, length is 0x121E0
        <MarshalAs(UnmanagedType.ByValArray, sizeconst:=&H1D20)> _
        Public Padding3() As Byte
        Private HallOfFame2 As mDPHallOfFameBlock 'Starts at 0x60000, length is 0x2AC0
        <MarshalAs(UnmanagedType.ByValArray, sizeconst:=&H1D540)> _
        Public Padding4() As Byte
#End Region

        Public Sub New()
            General1 = New mDPGeneralBlock
            Storage1 = New mDPStorageBlock
            Padding1 = Nothing
            HallOfFame1 = New mDPHallOfFameBlock
            Padding2 = Nothing
            General2 = New mDPGeneralBlock
            Storage2 = New mDPStorageBlock
            Padding3 = Nothing
            HallOfFame2 = New mDPHallOfFameBlock
            Padding4 = Nothing
            mGenCur = New mDPGeneralBlock
            mGenBack = New mDPGeneralBlock
            mStoCur = New mDPStorageBlock
            mStoBack = New mDPStorageBlock
            mHoFCur = New mDPHallOfFameBlock
            mHoFBack = New mDPHallOfFameBlock
            seeds = Nothing
        End Sub

#Region "Private Variables"
        <NonSerialized()> _
        Private Shared mGenCur As mDPGeneralBlock
        <NonSerialized()> _
        Private Shared mGenBack As mDPGeneralBlock
        <NonSerialized()> _
        Private Shared mStoCur As mDPStorageBlock
        <NonSerialized()> _
        Private Shared mStoBack As mDPStorageBlock
        <NonSerialized()> _
        Private Shared mHoFCur As mDPHallOfFameBlock
        <NonSerialized()> _
        Private Shared mHoFBack As mDPHallOfFameBlock
        <NonSerialized()> _
...
#End Region
        ...
        Public Function SaveData() As Byte()
            ...
            Dim _GENblock As mDPGeneralBlock = GeneralBlock
            Dim _STOblock As mDPStorageBlock = StorageBlock
            Dim _HOF As mDPHallOfFameBlock = HallOfFameBlock
...
#Region "User Accessible Blocks"
        ...
        Public Property GeneralBlock() As mDPGeneralBlock
            Get
                Return mGenCur
            End Get
            Set(ByVal value As mDPGeneralBlock)
                mGenCur = value
            End Set
        End Property

        Public Property StorageBlock() As mDPStorageBlock
            Get
                Return mStoCur
            End Get
            Set(ByVal value As mDPStorageBlock)
                mStoCur = value
            End Set
        End Property

        Public Property HallOfFameBlock() As mDPHallOfFameBlock
            Get
                Return mHoFCur
            End Get
            Set(ByVal value As mDPHallOfFameBlock)
                mHoFCur = value
            End Set
        End Property
...
#Region "User Hidden Blocks"
        ...
        Private ReadOnly Property GeneralBlockCurrent() As mDPGeneralBlock
            Get
                Return mGenCur
            End Get
        End Property

        Private ReadOnly Property GeneralBlockBackup() As mDPGeneralBlock
            Get
                Return mGenBack
            End Get
        End Property

        Private Property StorageBlockCurrent() As mDPStorageBlock
            Get
                Return mStoCur
            End Get
            Set(ByVal value As mDPStorageBlock)
        ...
        Private Property StorageBlockBackup() As mDPStorageBlock
            Get
                Return mStoBack
            End Get
            Set(ByVal value As mDPStorageBlock)
        ...
        Private ReadOnly Property HallOfFameBlockCurrent() As mDPHallOfFameBlock
            Get
                Return mHoFCur
            End Get
        End Property

        Private ReadOnly Property HallOfFameBlockBackup() As mDPHallOfFameBlock
            Get
                Return mHoFBack
            End Get
        End Property
...
#End Region
        ...
        Public ReadOnly Property Trainer() As mTrainer
            Get
                With GeneralBlock
                    Return New mTrainer(.trName, New mGender(.trGender), .trID, .trSID, False)
                End With
            End Get
        End Property
...
#Region "Pal Pad"
        ...
        Private Sub SetPalPad(ByVal NewPalPadFCs() As Byte, ByVal NewPalPadNames() As Byte)
            Array.Copy(NewPalPadFCs, 0, GeneralBlock.PalPadFCs, 0, NewPalPadFCs.Length)
            Array.Copy(NewPalPadNames, 0, GeneralBlock.PalPadNames, 0, NewPalPadNames.Length)
        End Sub
