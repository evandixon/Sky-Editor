    ...
    Public Class SkyStoredPokemon
        ...
        Private Sub Initialize(bits As Binary)
            With bits
                ...
                Attack1 = New SkyAttack(.Range(198, SkyAttack.Length))
                Attack2 = New SkyAttack(.Range(219, SkyAttack.Length))
                Attack3 = New SkyAttack(.Range(240, SkyAttack.Length))
                Attack4 = New SkyAttack(.Range(261, SkyAttack.Length))
