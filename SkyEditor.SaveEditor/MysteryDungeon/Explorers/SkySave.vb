...
#Region "Child Classes"
        ...
        Public Class QuicksaveAttack
            ...
            Public Property IsValid As Boolean
                ...
                End Set
            End Property
            Public Property IsLinked As Boolean Implements IExplorersActiveAttack.IsLinked
                Get
                    Return Bits(1)
                End Get
                Set(value As Boolean)
                ...
                End Set
            End Property
            Public Property IsSwitched As Boolean Implements IExplorersActiveAttack.IsSwitched
                Get
                    Return Bits(2)
                End Get
                Set(value As Boolean)
                ...
                End Set
            End Property
            Public Property IsSet As Boolean Implements IExplorersActiveAttack.IsSet
                Get
                    Return Bits(3)
                End Get
                Set(value As Boolean)
            ...
            'Unknown data: 8 bits
            Public Property ID As Integer Implements IExplorersActiveAttack.ID
                Get
                    Return Int(0, 16, 16)
                End Get
            ...
            Public Property PP As Integer Implements IExplorersActiveAttack.PP
                ...
                End Set
            End Property
            Public Property Ginseng As Integer Implements IExplorersActiveAttack.Ginseng
                Get
                    Return Int(0, 40, 8)
                End Get
                Set(value As Integer)
            ...
            Public ReadOnly Property GetAttackDictionary() As Dictionary(Of Integer, String) Implements IExplorersActiveAttack.MoveNames
                Get
