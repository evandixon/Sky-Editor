...
Public Class QPkmWindow
    ...
    Private Sub PkmWindow_Loaded(sender As Object, e As RoutedEventArgs) Handles Me.Loaded
        'Load Language
        lblPkm.Content = Lists.SkyEditorLanguageText("Pokemon")
        lblIsFemale.Content = Lists.SkyEditorLanguageText("IsFemale")
        'lblName.Content = Lists.SkyEditorLanguageText("Name")
        lblLevel.Content = Lists.SkyEditorLanguageText("Level")
        lblExp.Content = Lists.SkyEditorLanguageText("Exp")
        ...
        lblHP1.Content = Lists.SkyEditorLanguageText("CurrentHP")
        lblHP2.Content = Lists.SkyEditorLanguageText("MaxHP")
        lblAttack.Content = Lists.SkyEditorLanguageText("Attack")
        lblSpAttack.Content = Lists.SkyEditorLanguageText("SpAttack")
        lblDefense.Content = Lists.SkyEditorLanguageText("Defense")
        lblSpDefense.Content = Lists.SkyEditorLanguageText("SpDefense")

        lblMove.Content = Lists.SkyEditorLanguageText("Move")
        lblGinseng.Content = Lists.SkyEditorLanguageText("Ginseng")
        lblSet.Content = Lists.SkyEditorLanguageText("Set")
        lblSwitched.Content = Lists.SkyEditorLanguageText("Switched")
        lblLinked.Content = Lists.SkyEditorLanguageText("Linked")
        lblSealed.Content = Lists.SkyEditorLanguageText("Sealed")

        lblMove1.Content = Lists.SkyEditorLanguageText("Move1")
        lblMove2.Content = Lists.SkyEditorLanguageText("Move2")
        lblMove3.Content = Lists.SkyEditorLanguageText("Move3")
        lblMove4.Content = Lists.SkyEditorLanguageText("Move4")
