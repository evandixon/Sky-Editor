...
#Region "Child Classes"
    ...
    Public Class ProjectItem
        ...
        Public Sub New(Project As ProjectOld)
            Children = New List(Of ProjectItem)
            _p = Project
        End Sub

        Public Sub New(Project As ProjectOld, File As Object)
            Me.New(Project)
            _file = File
            IsDirectory = False
...
#Region "Create New"
    ...
    ''' <returns></returns>
    Public Shared Function CreateProject(ProjectDirectory As String, ProjectName As String) As ProjectOld
        Return CreateProject(ProjectDirectory, ProjectName, GetType(ProjectOld))
    End Function
    ...
    ''' <returns></returns>
    Public Shared Function CreateProject(ProjectDirectory As String, ProjectName As String, ProjectType As Type) As ProjectOld
        ...
        Dim output As ProjectOld = ProjectType.GetConstructor({}).Invoke({})
...
#End Region
    ...
    Public Overridable Function Build(Solution As SolutionOld) As Task
        Return Task.CompletedTask
    End Function

    Public Overridable Function CanBuild(Solution As SolutionOld) As Boolean
        Return False
    End Function
    ...
    Public Function GetReferences(Solution As SolutionOld) As IEnumerable(Of ProjectOld)
        Dim out As New List(Of ProjectOld)
    ...
    ''' <returns></returns>
    Public Function HasCircularReferences(Solution As SolutionOld) As Boolean
        Dim tree As New List(Of ProjectOld)
    ...
    Private Sub FillReferenceTree(Solution As SolutionOld, Tree As List(Of ProjectOld), CurrentItem As ProjectOld)
...
#Region "Open"
    ...
    ''' <returns></returns>
    Public Shared Function OpenProjectFile(Filename As String) As ProjectOld
        ...
        End If
        Dim out As ProjectOld = type.GetConstructor({}).Invoke({})
