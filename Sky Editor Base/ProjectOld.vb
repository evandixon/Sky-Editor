...
<Obsolete> Public Class ProjectOld
...
#Region "Overridable Functions"
    ...
    Public Overridable Function CreatableFiles(InternalPath As String, Manager As PluginManager) As IList(Of Type)
        Return Manager.GetCreatableFiles
    End Function

    ''' <summary>
    ''' Returns whether or not the project type supports building.
    ''' </summary>
    ''' <returns></returns>
    ...
    ''' <summary>
    ''' Returns whether or not the project type supports running.
    ''' </summary>
    ''' <returns></returns>
    ...
    ''' <summary>
    ''' Returns whether or not the project type supports archival.
    ''' </summary>
    ''' <returns></returns>
...
#End Region
    ...
    Public Shared Async Function OpenProject(Filename As String, Manager As PluginManager) As Task(Of ProjectOld)
