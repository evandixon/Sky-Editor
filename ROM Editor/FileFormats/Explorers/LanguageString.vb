...
Namespace FileFormats.Explorers
    Public Class LanguageString
        ...
        Public Sub UpdatePersonalityTestResult(Results As PersonalityTestContainer)
            UpdatePersonalityTestResult(HardyMale, Results.HardyMalePokemon)
            UpdatePersonalityTestResult(HardyFemale, Results.HardyFemalePokemon)
            UpdatePersonalityTestResult(DocileMale, Results.DocileMalePokemon)
            UpdatePersonalityTestResult(DocileFemale, Results.DocileFemalePokemon)
            UpdatePersonalityTestResult(BraveMale, Results.BraveMalePokemon)
            UpdatePersonalityTestResult(BraveFemale, Results.BraveFemalePokemon)
            UpdatePersonalityTestResult(JollyMale, Results.JollyMalePokemon)
            UpdatePersonalityTestResult(JollyFemale, Results.JollyFemalePokemon)
            UpdatePersonalityTestResult(ImpishMale, Results.ImpishMalePokemon)
            UpdatePersonalityTestResult(ImpishFemale, Results.ImpishFemalePokemon)
            UpdatePersonalityTestResult(NaïveMale, Results.NaiveMalePokemon)
            UpdatePersonalityTestResult(NaïveFemale, Results.NaiveFemalePokemon)
            UpdatePersonalityTestResult(TimidMale, Results.TimidMalePokemon)
            UpdatePersonalityTestResult(TimidFemale, Results.TimidFemalePokemon)
            UpdatePersonalityTestResult(HastyMale, Results.HastyMalePokemon)
            UpdatePersonalityTestResult(HastyFemale, Results.HastyFemalePokemon)
            UpdatePersonalityTestResult(SassyMale, Results.SassyMalePokemon)
            UpdatePersonalityTestResult(SassyFemale, Results.SassyFemalePokemon)
            UpdatePersonalityTestResult(CalmMale, Results.CalmMalePokemon)
            UpdatePersonalityTestResult(CalmFemale, Results.CalmFemalePokemon)
            UpdatePersonalityTestResult(RelaxedMale, Results.RelaxedMalePokemon)
            UpdatePersonalityTestResult(RelaxedFemale, Results.RelaxedFemalePokemon)
            UpdatePersonalityTestResult(LonelyMale, Results.LonelyMalePokemon)
            UpdatePersonalityTestResult(LonelyFemale, Results.LonelyFemalePokemon)
            UpdatePersonalityTestResult(QuirkyMale, Results.QuirkyMalePokemon)
            UpdatePersonalityTestResult(QuirkyFemale, Results.QuirkyFemalePokemon)
            UpdatePersonalityTestResult(QuietMale, Results.QuietMalePokemon)
            UpdatePersonalityTestResult(QuietFemale, Results.QuietFemalePokemon)
            UpdatePersonalityTestResult(RashMale, Results.RashMalePokemon)
            UpdatePersonalityTestResult(RashFemale, Results.RashFemalePokemon)
            UpdatePersonalityTestResult(BoldMale, Results.BoldMalePokemon)
            UpdatePersonalityTestResult(BoldFemale, Results.BoldFemalePokemon)
        End Sub
